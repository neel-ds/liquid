...
export default function CreateForm() {
  ...
  return (
    <section className="bg-gradient-radial from-[#2d4e56] to-[#0E0E0E] py-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="max-w-xl mx-auto mt-4 text-gray-300 text-lg leading-relaxed">
            Brag your work to the most exciting audience on GHO and earn hefty
            rewards in GHO. Build, Share & Grow!
          </p>
        </div>
        <div className="max-w-5xl mx-auto mt-6 sm:mt-8">
          <div className="mt-6 overflow-hidden bg-gradient-radial from-[#112c2c] to-[#071a1c] rounded-xl">
                ...
                <div className="flex justify-center mb-5">
                  <div className="flex flex-row items-center space-x-2">
                    <Image
                      ...
                      src={icon !== "" ? icon : "/svgs/preview.svg"}
                      loader={({ src }) => src}
                      alt="profile"
                      width={150}
                      height={150}
                    ...
                    <div className="flex flex-col space-y-2">
                      <label className="text-base font-medium text-teal-50">
                        Upload your pfp
                      </label>
