  ...
  return (
    <div className="relative lg:h-[100vh] pb-12 overflow-hidden">
      ...
      <Image
        ...
        width={250}
      />
      <div className="hidden lg:block absolute top-0 left-0 md:w-5/12 xl:w-4/12 -ml-5 h-full"></div>
        ...
        <div className="container px-4 mx-auto">
          <div className="flex items-center">
            ...
            <ul className="hidden lg:flex ml-2 lg:w-auto lg:space-x-14 items-center">
              <li>
                <Link
                  className="inline-block text-3xl text-white font-['Roobert'] hover:text-teal-200 font-bold"
                  href={"/"}
                >
                  LIQUID
                </Link>
          ...
          <div className="flex flex-wrap -mx-4 items-center">
            <div className="w-full lg:w-2/5 px-4 mb-16 lg:mb-0">
              <div className="relative max-w-md mx-auto lg:mx-0">
                <Image
                  className="block h-112 md:h-150 w-full blur-[2px]"
                  src="/svgs/asset.svg"
                  alt=""
                  height={150}
                  width={150}
                ...
                <div className="absolute bottom-0 left-0 p-7">
                  <div className="p-6 bg-teal-100 shadow-2xl shadow-gray-500 backdrop-blur-md rounded-2xl">
                    <div className="flex mb-14 items-center">
                      <Image
                        className="w-12 h-12 rounded-full"
                        src="/images/pfp/pfp_1.png"
                        alt=""
                        height={150}
                        width={150}
                      />
                    ...
                    <span className="block mb-2 text-4xl font-bold">469+</span>
            ...
            <div className="w-full lg:w-3/5 px-4">
              <div className="max-w-md lg:max-w-2xl mx-auto lg:mr-0">
                ...
                <div className="md:flex mb-14 max-w-xs sm:max-w-sm md:max-w-none">
                  <div className="mb-6 md:mb-0 md:mr-8 pt-3 text-gray-200">
                    <svg
                      width="84"
                      height="10"
                      viewBox="0 0 84 10"
                ...
                <div className="sm:flex items-center">
                  <Link
                    ...
                    href="/signup"
                  >
                    <div className="absolute top-0 right-full w-full h-full bg-orange-500 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
